...
- **交互式报告** — [综合研究报告：宝可梦 VGC 多人对战设计演进](docs/index.html) — 可交互的 10 条设计原则速查、时间轴、检查清单、决策树

### 交互式报告特色功能

- **10条设计原则**（三层架构：战斗设计/多人协作/Meta与运营）
- **47条检查清单**（7个维度，含详细决策逻辑指南）
- **历代时间轴**（含世代综述卡、演进链纵向索引、双向关联系统）
- **决策树诊断**（快速定位设计问题 → 场景详情弹窗）
- **快速诊断入口**（首页6类问题快速定位）
- **已移除机制详情**（含结构化分析：移除原因/因果分析/设计启示）
